            ...
            <div class="carousel-container">
              <div class="carousel-content container">
                <div class="col-md-8">
                  ...
                  <p class="animate__animated animate__fadeInUp">We are here to provide the latest website development services, affordable prices and easy to access. Available for UKM / UMKM, government instance to companies.</p>                  
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 video-box">
            <img src="<?php echo get_theme_file_uri( 'assets/img/tugu-1080.jpg' ); ?>" class="img-fluid" alt="">
          </div>
